...
function draw_countries({ countries_svg, x, y, r, o }) {
  ...
  let text = countries_svg.select("text");
  text.style("pointer-events", "none");
  /* On ajoute un contour pour les bulles des pays */
  text.style("stroke", "#000000");
  text.style("stroke-width", "1px");
  ...
  countries_svg
    ...
    .attr("x", d => x(d.income[year_index]))
...
function start_timer() {
  ...
  /* Question 1 : On désactive les buttons qui ne sont plus nécessaires */
  play_button.style("pointer-events", "none");
  pause_button.style("pointer-events", "auto");
}

function pause_timer() {
  t.stop();
  /* Question 1 : On désactive les buttons qui ne sont plus nécessaires */
  pause_button.style("pointer-events", "none");
  play_button.style("pointer-events", "auto");
}
